            ...
            function getAdBlockDiv() {
                ...
                if (playerRootDiv != null) {
                    ...
                    if (adBlockDiv == null) {
                        ...
                        adBlockDiv.innerHTML = '<div class="player-adblock-notice" style="color: red; background-color: rgba(0, 0, 1, 0.8); position: absolute; top: 0px; left: 0px; padding: 5px;"><p></p></div>';
                        adBlockDiv.style.display = 'none';
